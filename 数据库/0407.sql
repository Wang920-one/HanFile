...
CREATE TABLE `articles` (
  ...
  `actImg` varchar(255) DEFAULT NULL COMMENT '稿件封面',
...
insert  into `articles`(`atcId`,`userId`,`bioati`,`actImg`,`atcDescribe`,`atcType`,`atcLabel`,`atcBrowse`,`atcThumes`,`atcTime`,`actShare`,`actText`,`actReview`) values (1,1,'1','1','1','1','1',1,1,'2021-04-01 20:24:03',0,NULL,0);
...
CREATE TABLE `hanfuactivity` (
  ...
  `acSponsor` varchar(255) NOT NULL COMMENT '活动主办方',
  `acDetails` varchar(255) NOT NULL COMMENT '活动详情',
...
insert  into `hanfuactivity`(`acId`,`acName`,`acAddress`,`acTime`,`acForm`,`acSponsor`,`acDetails`,`acImg`) values (2,'432','312','2021-04-06','123','123','123123w1e......................................=---------------------------------------------------------------','/img/activePic/16176913101302.jpg'),(5,'ewqe','qw','2021-03-29','e2e','qwe','e21e','/img/defualt/active.png'),(6,'ewqe432','qw342','2021-02-28','e2e423','qwe423','e2','/img/defualt/active.png'),(7,'2311','321','2021-01-31','213','13','342','/img/defualt/active.png'),(8,'231','123','2021-03-28','123','123','123','/img/defualt/active.png'),(9,'1','2','2021-03-29','1','1','1','/img/defualt/active.png');
...
insert  into `hanfuknows`(`knowsId`,`knowsName`,`knowsClass`,`knowsContainer`,`knowsImage`) values (1,'神话及传说时代汉服','汉服历史介绍','神话及传说起源——中华始祖，传说中的上古帝王轩辕氏 黄帝 统一华夏部落。在他治下，政治安定，文化进步，国势强盛，有很多的发明和创作，如文字，农业，音乐，历法等。黄帝的正妃 嫘祖，传说中就是她首创养蚕制丝织绢，从而发明了汉服。',NULL),(2,'夏朝汉服','汉服历史介绍','夏朝的服饰以黑为主。',NULL);
...
insert  into `user`(`userId`,`userAccount`,`userName`,`userPassword`,`userSex`,`userImage`,`createTime`,`updateTime`,`userPhone`,`userQQ`,`userAddress`,`userBirthday`,`userSign`,`userBackImg`,`userEmail`) values (1,'111111','wang','1',0,'/img/userPic/16176984305512.jpg','2021-03-16 00:00:00','2021-04-06 00:00:00','12345678','123456789',NULL,NULL,NULL,NULL,'12345678@qq.com'),(2,'432','32','23',1,'/img/userPic/16177004888671 (2).jpg','2021-03-31 00:00:00','2021-04-06 00:00:00','21312312','12312312','daed','2021-04-01 00:00:00','3e2eqwe',NULL,'e3214213');
...
CREATE TABLE `video` (
  ...
  `videoImg` varchar(255) DEFAULT NULL COMMENT '封面',
  `videoDes` varchar(255) DEFAULT NULL COMMENT '描述',
  `videoType` tinyint(1) DEFAULT NULL COMMENT '分类',
...
insert  into `video`(`videoId`,`userId`,`videoTitle`,`videoImg`,`videoDes`,`videoType`,`videoLabel`,`videoBrowse`,`videoThumes`,`videoTime`,`videoShare`,`videoFile`,`videoReview`) values (1,1,'1','1','1',1,'1',1,NULL,NULL,NULL,NULL,0);
