...
insert  into `articles`(`atcId`,`userId`,`bioati`,`pic`,`atcDescribe`,`atcType`,`atcLabel`,`atcBrowse`,`atcThumes`,`atcTime`,`actShare`,`actText`,`actReview`) values 
...
insert  into `video`(`videoId`,`userId`,`videoTitle`,`pic`,`videoDes`,`videoType`,`videoLabel`,`videoBrowse`,`videoThumes`,`videoTime`,`videoShare`,`videoFile`,`videoReview`) values 
(1,1,'1','/img/defualt/video.png','1','发型','1',1,NULL,NULL,NULL,NULL,0),
(2,2,'而我却','/img/defualt/video.png','我','种草',NULL,0,0,NULL,0,NULL,0),
(3,3,'4324','/img/defualt/video.png','234','发型','213',0,0,NULL,0,NULL,1),
(4,1,'12','/img/defualt/video.png','123','搭配','人',0,0,NULL,0,NULL,0),
(5,3,'委屈','/img/defualt/video.png','额','妆容',NULL,0,0,NULL,0,NULL,0),
(6,3,'2123','/img/defualt/video.png','1231','妆容',NULL,0,0,NULL,0,NULL,0),
(7,4,'we','/img/defualt/video.png','qwe','搭配',NULL,0,0,NULL,0,NULL,0);
