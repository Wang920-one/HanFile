...
CREATE TABLE `articles` (
  ...
  `atcTile` varchar(255) NOT NULL COMMENT '稿件标题',
  `actImg` varchar(255) NOT NULL COMMENT '稿件封面',
  `atcDescribe` varchar(255) NOT NULL COMMENT '稿件描述',
  `atcType` varchar(10) NOT NULL COMMENT '稿件分类',
  `atcLabel` varchar(10) DEFAULT NULL COMMENT '稿件标签',
  `atcBrowse` int(10) NOT NULL COMMENT '稿件浏览量，热门榜',
  `atcThumes` int(10) NOT NULL COMMENT '稿件点赞量，点赞榜',
  `atcTime` date NOT NULL COMMENT '稿件发布时间,最新动态',
  `actShare` int(10) NOT NULL COMMENT '稿件分享量',
  `actText` text COMMENT '专栏内容',
  `actVideo` varchar(255) DEFAULT NULL COMMENT '视频内容',
  PRIMARY KEY (`atcId`),
  KEY `用户` (`userId`),
...
insert  into `hanfushop`(`shopId`,`shopName`,`shopHttp`,`shopImage`,`shopYear`,`shopFans`) values (1,'汉尚华莲','https://hanshanghualian.tmall.com/shop/view_shop.htm?user_number_id=3358098495&ali_trackid=2%3Amm_16143309_397250212_106971550493%3A1617422133_246_258436896&union_lens=recoveryid%3A1617422133_246_258436896&bxsign=tbkKRmXlzFaJ3xpQMKPxF8IUYBJSETbguxzDYUMMgG','/img/shopPic/1617630528988清水溪.jpeg','2021-01-14 00:00:00',232122),(2,'和啊',NULL,'/img/shopPic/1617617876199池夏.png',NULL,NULL),(3,'21','321','/img/shopPic/hhh.jpg','2021-03-29 00:00:00',21),(4,'wqe','212','/img/shopPic/hhh.jpg','2021-03-28 00:00:00',213),(5,'eqw','qwe','/img/shopPic/hhh.jpg','2021-03-28 00:00:00',1213),(6,'we','q2','/img/shopPic/hhh.jpg','2021-03-29 00:00:00',231),(7,'e1','1213','/img/shopPic/hhh.jpg','2021-03-29 00:00:00',12321),(8,'we','12','/img/defualt/shop.png','2021-03-28 00:00:00',123);
...
CREATE TABLE `user` (
  ...
  `userImage` varchar(255) NOT NULL COMMENT '用户头像',
...
insert  into `user`(`userId`,`userAccount`,`userName`,`userPassword`,`userSex`,`userImage`,`createTime`,`updateTime`,`userPhone`,`userQQ`,`userAddress`,`userBirthday`,`userSign`,`userBackImg`,`userEmail`) values (1,'111111','wang','1',0,'','2021-03-16','0000-00-00','12345678','123456789',NULL,NULL,NULL,NULL,'12345678@qq.com');
