...
CREATE TABLE `manage` (
  ...
  `manageSex` tinyint(1) DEFAULT NULL COMMENT '管理员性别',
...
CREATE TABLE `user` (
  ...
  `userSex` tinyint(1) NOT NULL COMMENT '用户性别',
  ...
  `userAddres` varchar(255) CHARACTER SET latin1 DEFAULT NULL COMMENT '用户地址',
